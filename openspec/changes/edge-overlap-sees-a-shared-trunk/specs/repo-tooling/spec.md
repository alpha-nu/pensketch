...
> One number moves. `@pensketch/core/check` goes from 3072 to 3264 bytes,
...
> carried word for word and none added. The only edit is `3072` to `3264` in
...
`@pensketch/core` exceeds 5120 bytes, `@pensketch/core/check` exceeds 3264
