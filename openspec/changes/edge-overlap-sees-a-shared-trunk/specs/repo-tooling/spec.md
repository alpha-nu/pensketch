...
> One number moves. `@pensketch/core/check` goes from 3072 to 3392 bytes,
...
> carried word for word and none added. The only edit is `3072` to `3392` in
...
`@pensketch/core` exceeds 5120 bytes, `@pensketch/core/check` exceeds 3392
