...
### Requirement: A diagram is bounded
...
Nobody hand-writes 500 nodes, so what the bound catches is a generated
diagram. A refusal naming the count is something the caller can act on, where
a call that merely takes a minute is a turn it can neither spend nor explain.
