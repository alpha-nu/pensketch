...
export default defineConfig({
  test: {
    ...
    coverage: {
      ...
      // `serve-http.ts` binds a port, so neither can be covered by importing
      // it. Both are transport entries of a few lines, and both are verified
      ...
      exclude: [
        ...
        'packages/mcp/src/serve-http.ts',
      ],
